...
# Fill remaining NaN with 0 (no return = stock not traded that month)
ret_matrix = ret_matrix.fillna(0)

# Keep only months where we have at least 50 stocks
ret_matrix = ret_matrix.loc[ret_matrix.astype(bool).sum(axis=1) >= 50]
